...
<div class="text dark:bg-gray-900">
  <div>
    <div class="relative">
      <!-- For md screen size -->
      <div id="md-searchbar" class="bg-white dark:bg-white hidden lg:hidden py-5 px-6 items-center justify-between shadow-lg">
        <div class="flex items-center space-x-3 text-green-600 hover:text-green-800 dark:text-white">
          ...
          <input type="text" placeholder="Search for products" class="text-sm bg-white leading-none dark:text-gray-300 dark:bg-[#a1cd46} text-green-600 hover:text-green-800 focus:outline-none" />
        </div>
        <div class="space-x-6">
          <button aria-label="view favourites" class="text-green-600 hover:text-green-800 dark:text-white focus:outline-none">
          ...
          <button aria-label="go to cart" class="text-green-600 hover:text-green-800 dark:text-white focus:outline-none">
          ...
          <button aria-label="user" class="text-green-600 hover:text-green-800 dark:hover:text-gray-300 dark:text-white focus:outline-none">
      ...
      <div class="dark:bg-[#a1cd46} bg-white px-6 py-6 shadow-lg">
        <div class="container mx-auto flex items-center justify-between">
          <h1 class="text-2xl cursor-pointer text-green-600 hover:text-[#AA8B56] dark:text-white" aria-label="the Crib.">
          ...
          <ul class="hidden w-8/12 md:flex items-center justify-center space-x-8">
            <li>
              <a href="javascript:void(0)" class="dark:text-white text-bold text-green-600 hover:text-green-800 focus:outline-none hover:underline"><b>Home</b></a>
            </li>
            <li>
              <a href="javascript:void(0)" class="dark:text-white text-bold text-green-600 hover:text-green-800 focus:outline-none hover:underline"><b>Furniture</b></a>
            </li>
            <li>
              <a href="javascript:void(0)" class="dark:text-white text-bold text-green-600 hover:text-green-800 focus:outline-none hover:underline"><b>Lookbook</b></a>
            </li>
            <li>
              <a href="javascript:void(0)" class="dark:text-white text-bold text-green-600 hover:text-green-800 focus:outline-none hover:underline"><b>Support</b></a>
            </li>
          </ul>

          <div class="text-2xl justify-end flex items-center space-x-4 xl:space-x-8">
            <div class="hidden lg:flex items-center">
              <button onclick="toggleSearch()" aria-label="search items" class="text-green-600 hover:text-green-800 dark:hover:text-gray-300 dark:text-white focus:outline-none">
              ...
              <input id="searchInput" type="text" placeholder="search" class="hidden bg-white text-sm dark:bg-[#a1cd46} dark:placeholder-gray-300 text-green-600 hover:text-green-800 rounded ml-1 border border-transparent focus:outline-none focus:border-green-600 hover:text-green-800 px-1" />
            </div>
            <div class="hidden lg:flex items-center space-x-4 xl:space-x-8">
              <button aria-label="view favourites" class="text-green-600 hover:text-green-800 dark:hover:text-gray-300 dark:text-white focus:outline-none">
                <svg class="fill-stroke" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <button aria-label="go to cart" class="text-green-600 hover:text-green-800 dark:hover:text-gray-300 dark:text-white focus:outline-none">
            ...
            <div class="flex lg:hidden">
              <button aria-label="show options" onclick="mdOptionsToggle()" class="text-black dark:text-white dark:hover:text-gray-300 hidden md:flex focus:outline-none rounded focus:ring-green-600 hover:text-green-700">
                <svg class="fill-stroke" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <button aria-label="open menu" onclick="openMenu()" class="text-black dark:text-white dark:hover:text-gray-300 md:hidden focus:outline-none rounded focus:ring-green-600 hover:text-green-700">
                <svg class="fill-stroke" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M4 6H20" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M10 12H20" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M6 18H20" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
      ...
      <!-- For small screen -->
      <div id="mobile-menu" class="hidden absolute dark:bg-[#a1cd46} z-10 inset-0 md:hidden bg-white flex flex-col h-screen w-full">
        <div class="flex items-center justify-between border-b border-gray-200 dark:border-gray-700 pb-4 p-4">
          <div class="flex items-center space-x-3">
            <div>
              <svg class="fill-stroke text-green-600 hover:text-green-800 dark:text-white" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <input type="text" placeholder="Search for products" class="text-sm bg-white dark:bg-[#a1cd46} text-green-600 hover:text-green-800 placeholder-green-600 hover:text-green-800 dark:placeholder-gray-300 focus:outline-none" />
          </div>

          <button onclick="closeMenu()" aria-label="close menu" class="focus:outline-none rounded focus:ring-green-600 hover:text-green-700">
            <svg class="fill-stroke text-green-600 hover:text-green-800 dark:text-white" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="mt-6 p-4">
          <ul class="flex flex-col space-y-6">
            <li>
              <a href="javascript:void(0)" class="dark:text-white flex items-center justify-between hover:underline text-bold text-green-600 hover:text-green-800 focus:outline-none">
                Home
                <div>
        ...
        <div class="flex items-end">
          <ul class="flex flex-col space-y-8 bg-white w-full py-10 p-4 dark:bg-gray-800">
            <li>
              <a href="javascript:void(0)" class="dark:text-white text-green-600 hover:text-green-800 flex items-center space-x-2 focus:outline-none hover:underline">
                <div>
